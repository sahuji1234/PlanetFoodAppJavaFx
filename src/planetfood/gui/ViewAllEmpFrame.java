...
public class ViewAllEmpFrame extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jtViewAllEmp.setBackground(new java.awt.Color(0, 102, 102));
        jtViewAllEmp.setForeground(new java.awt.Color(255, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        public void showAllData(){
            try{
                ArrayList<Employees> empList=EmployeesDao.getAllEmployees();
                if(empList.isEmpty()==true){
                    ...
                    DefaultTableModel model=(DefaultTableModel)jtViewAllEmp.getModel();
